...
# <a name="gpmll"/></a>General-Purpose Machine Learning Libraries
...
# <a name="dll"/></a>Deep Learning Libraries
...
### <a name="dlmc"/></a>Deep Learning: Model Compression
...
# <a name="tts"/></a>Speech Recognition (TTS) and Generation (STT)
...
# <a name="ocr"/></a>Text Recognition (OCR)
...
# <a name="web"/></a>Machine Learning Web APIs
...
# <a name="mlapps"/></a>Opensource ML Applications
...
### <a name="stat"/></a>Statistics, random numbers
...
### <a name="mo"/></a>Mathematical optimization
...
### <a name="dv"/></a>Data Visualization
...
### <a name="bio"/></a>Bioinformatics (kinda)
...
### <a name="bd"/></a>Big Data (not really)
...
# <a name="gpublogs"/></a>GPU Computing Blogs
...
# <a name="learn"/></a>Learn Machine Learning
