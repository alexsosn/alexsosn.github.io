...
# <a name="gpmll"/>General-Purpose Machine Learning Libraries</a>
...
# <a name="dll"/>Deep Learning Libraries</a>
...
### <a name="dlmc"/>Deep Learning: Model Compression</a>
...
# <a name="tts"/>Speech Recognition (TTS) and Generation (STT)</a>
...
# <a name="ocr"/>Text Recognition (OCR)</a>
...
# <a name="web"/>Machine Learning Web APIs</a>
...
# <a name="mlapps"/>Opensource ML Applications</a>
...
### <a name="stat"/>Statistics, random numbers</a>
...
### <a name="mo"/>Mathematical optimization</a>
...
### <a name="fe"/>Feature extraction</a>
...
### <a name="bio"/>Bioinformatics (kinda)</a>
...
### <a name="bd"/>Big Data (not really)</a>
...
# <a name="gpublogs"/>GPU Computing Blogs</a>
...
# <a name="learn"/>Learn Machine Learning</a>
